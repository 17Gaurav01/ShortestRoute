...
class Body:
	...
	def write(self):
		...
		self.pen.write("shortest route",False,align="left",font=("arial",20,"bold"))
		# self.pen.goto(-480,270)
		# self.pen.write("Instructions:",False,align="left",font=("arial",15,"bold"))
		self.pen.goto(-480,250)
		self.pen.write("a) Press 'S' in to put source point",False,align="left",font=("arial",10,"bold"))
		self.pen.goto(-480,230)
		self.pen.write("b) Press 'E' in to put destination point",False,align="left",font=("arial",10,"bold"))
		self.pen.goto(-480,210)
		self.pen.write("c) Press 'H' to make barriers",False,align="left",font=("arial",10,"bold"))
		self.pen.goto(-480,190)
		self.pen.write("d) Press 'L' to start your journey",False,align="left",font=("arial",10,"bold"))
		self.pen.goto(-480,170)
		self.pen.write("e) Press 'C' to clear",False,align="left",font=("arial",10,"bold"))
